    ...
    return (
        <div onClick={handleonClose} id="container" className=" inset-0 fixed bg-black bg-opacity-50 backdrop-blur-md flex justify-center items-center">
            ...
            <div className="bg-white flex flex-col rounded-2xl shadow-lg p-10 sm:max-w-5xl max-w-[90%]">
                <h1 className="font-bold text-2xl text-[#376549]">Verify OTP</h1>
                <p className="text-xs mt-4 text-[#477E56]">Enter th OTP.</p>
                <form className="flex flex-col gap-4" onSubmit={formik.handleSubmit}>
                    <input className="p-2 w-[100%] mt-8 rounded-[12px] border-2 border-[#AAD468] focus:border-teal-500 focus:outline-none text-xs text-[gray]" {...formik.getFieldProps('OTP')} type="text" placeholder='OTP*' />
